...
const Settings = () => {
  ...
  const handleRegenerateApiKey = async () => {
    ...
    try {
      ...
      const newApiKey = 'sk_live_' + Math.random().toString(36).substring(2, 38);
  ...
  const handleUpdateNestedSettings = (parentKey: string, childKey: string, value: any) => {
    setSettings(prev => ({
      ...prev,
      [parentKey]: {
    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-slate-600">Manage your account preferences and API configuration</p>
        </div>
      </motion.div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Manage your API keys and webhook settings</p>
              </div>
            </div>
          </CardHeader>
          ...
          <CardBody className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Use this key to authenticate your API requests</p>
                </div>
                <div className="flex gap-2">
                  <Button
                    ...
                    startContent={<Icon icon={showApiKey ? "mdi:eye-off" : "mdi:eye"} className="w-4 h-4" />}
                  >
                ...
                <Input
                  ...
                  endContent={
                    <Button
                      size="sm"
                      variant="light"
                      onPress={() => navigator.clipboard.writeText(settings.apiKey)}
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-slate-500">Receive real-time notifications about message events</p>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  variant="bordered"
                  startContent={<Icon icon="mdi:test-tube" className="w-4 h-4" />}
                >
                  Test
                </Button>
              </div>
          ...
          <CardBody className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onValueChange={(value) => handleUpdateNestedSettings('notifications', 'email', value)}
                color="primary"
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-slate-500">Receive notifications via SMS</div>
              </div>
              <Switch
                isSelected={settings.notifications.sms}
                onValueChange={(value) => handleUpdateNestedSettings('notifications', 'sms', value)}
                color="primary"
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="font-medium text-slate-900">Webhook Notifications</div>
                <div className="text-sm text-slate-500">Send notifications to your webhook</div>
              </div>
              <Switch
                isSelected={settings.notifications.webhook}
                onValueChange={(value) => handleUpdateNestedSettings('notifications', 'webhook', value)}
                color="primary"
              />
            </div>
          </CardBody>
          ...
          <CardBody className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onValueChange={(value) => handleUpdateNestedSettings('security', 'twoFactorAuth', value)}
                color="primary"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <Select
                ...
                onChange={(e) => handleUpdateNestedSettings('security', 'sessionTimeout', parseInt(e.target.value))}
                variant="bordered"
              >
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-100 rounded-xl flex items-center justify-center">
                <Icon icon="mdi:credit-card" className="w-5 h-5 text-orange-600" />
              </div>
              <div>
          ...
          <CardBody className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="text-sm text-slate-500">
                Next billing date: {new Date(settings.billing.nextBilling).toLocaleDateString()}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-slate-500">Automatically renew your subscription</div>
              </div>
              <Switch
                isSelected={settings.billing.autoRenew}
                onValueChange={(value) => handleUpdateNestedSettings('billing', 'autoRenew', value)}
                color="primary"
              />
            </div>
            ...
            <div className="space-y-3">
              <Button
                variant="bordered"
                className="w-full"
                startContent={<Icon icon="mdi:credit-card" className="w-4 h-4" />}
              >
                Manage Billing
              </Button>
              <Button
      ...
      >
        <Card className="border border-red-200 bg-red-50">
          <CardHeader>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-red-100 rounded-xl flex items-center justify-center">
                <Icon icon="mdi:alert-triangle" className="w-5 h-5 text-red-600" />
              </div>
              <div>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalContent>
          <ModalHeader>
            <h3 className="text-lg font-semibold text-red-900">Regenerate API Key</h3>
          </ModalHeader>
          
          <ModalBody>
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 bg-red-50 rounded-xl border border-red-200">
                <Icon icon="mdi:alert-triangle" className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                <div className="text-sm text-red-800">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>You'll need to update all integrations with the new key</li>
              ...
              <p className="text-sm text-slate-600">
                Are you sure you want to regenerate your API key? This action will immediately invalidate your current key.
              </p>
            </div>
          </ModalBody>
